...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Mozilla Gateway." \
                    "Please say the command you want."
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for using the Mozilla Gateway. " \
                    "Keep rocking on the free web! "
...
def on_intent(intent_request, session):
    ...
    if intent_name == "ActionIntent":
        return call_gateway_session(intent, session)
